...
class ExerciseTableViewController: UITableViewController {
    ...
    var sectionExercises: [String] = ["Abs", "Arms", "Legs", "Biceps"]
    var numberOfRowsAtSection: [Int] = [3, 4, 1, 2]
    ...
    override func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        headerCell.nameTextField.text = sectionExercises[section]
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: cellIdentifier, for: indexPath) as! ExerciseCell
        
       
        
        cell.repsTextField.text = (String) (numberOfRowsAtSection[indexPath.row])
